...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'seriesaldia_9332e41be1a954188497_20210509235925_archive.zip';
	const ARCHIVE_SIZE		 = '32741181';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '9332e41-09235925';
    const SECONDARY_PACKAGE_HASH = '8687dec-09235925';
	const VERSION			 = '1.4.0';
